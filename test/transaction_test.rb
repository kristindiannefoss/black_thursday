...
class TransactionTest < Minitest::Test
  ...
  def setup
    @transaction = Transaction.new({
                                    ...
                                    :result => "success",
                                    :created_at => Time.new("2012-02-26 20:56:58 UTC"),
                                    :updated_at => Time.new("2012-02-26 20:56:58 UTC")
                                  })
  end
  ...
  def test_it_returns_a_created_at
    assert_equal Time.new("2012-02-26 20:56:58 UTC"), @transaction.created_at
  end

  def test_it_returns_an_updated_at
    assert_equal Time.new("2012-02-26 20:56:58 UTC"), @transaction.updated_at
  end
